    ...
    <nav className="sticky top-0 z-50 w-full border-b border-zinc-800 bg-zinc-950/80 backdrop-blur-md">
      <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between gap-2 px-3 sm:px-6 lg:px-8">
        <div className="flex min-w-0 items-center gap-2 sm:gap-4">
          <Link to="/" className="shrink-0 text-xl font-black uppercase italic tracking-tighter text-orange-500 sm:text-2xl">
            Bnoy
          </Link>
        ...
        <div className="flex shrink-0 items-center gap-2 sm:gap-4">
          {user ? (
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <Link 
                to="/auth" 
                className="rounded-full bg-orange-500 px-3 py-2 text-xs font-bold text-white shadow-lg shadow-orange-500/20 transition-colors hover:bg-orange-600 sm:px-5 sm:text-sm"
              >
                Join Now
              </Link>
            </div>
